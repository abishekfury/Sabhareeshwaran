...
function initPageWrapper() {
  ...
  children.forEach(child => {
    if (child.tagName === 'SCRIPT' ||
      ...
      child.classList.contains('custom-cursor-follower') ||
      child.classList.contains('page-wrapper-close') ||
      child.id === 'custom-cursor-canvas') {
      return;
    }
...
function initCustomCursor() {
  ...
  setupCursorHover('a, button, [role="button"], .clickable, .theme-toggle-btn, .cert-node, .view-tab-btn, .matrix-scroll-arrow, .matrix-scroll-thumb, .menu-option-link, .page-wrapper-close, .nav-drawer-close, .nav-menu-btn, .nav-cta, .nav-logo', 'hover-link');
