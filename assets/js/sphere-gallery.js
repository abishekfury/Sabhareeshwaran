...
const GALLERY_IMAGES = [
  ...
  { src: 'assets/images/about7.webp', title: 'Technology Mentor', desc: 'Guiding freshers and professionals through transition pathways.' },
  { src: 'assets/images/about8.webp', title: 'Innovation Leader', desc: 'Building future-proof strategies for AI and quantum security.' },
  { src: 'assets/images/about9.webp', title: 'Corporate Trainer', desc: 'Upholding cybersecurity awareness programs for enterprises.' },
  { src: 'assets/images/about10.webp', title: 'Technical Author', desc: 'Writing standard operating procedures, documentation, and technical articles.' },
  { src: 'assets/images/img5.webp?v=3', title: 'Star of Fastohit 2k23', desc: 'Overall champion trophy presentation.' },
  { src: 'assets/images/img7.webp?v=3', title: 'Sathyabama University Speaker', desc: 'Ethical hacking & cybercrime seminar.' },
  { src: 'assets/images/img8.webp?v=3', title: 'Care Group of Institutions', desc: 'Network security architectural training.' },
  { src: 'assets/images/img9.webp?v=3', title: 'Firewall & SIEM Demos', desc: 'Teaching enterprise defense strategies.' },
  { src: 'assets/images/img10.webp?v=3', title: 'Infrastructure Lab Session', desc: 'Hands-on session with firewall controls.' },
  { src: 'assets/images/img11.webp?v=3', title: 'Sathyabama Session Speaker', desc: 'Engaging future cybersecurity professionals.' },
  { src: 'assets/images/service1.webp', title: 'SOC Operations Showcase', desc: 'Security Operations Center dashboard overview.' },
  { src: 'assets/images/service2.webp', title: 'Vulnerability Assessment Lab', desc: 'Vulnerability scanning and remediation demo.' },
  { src: 'assets/images/service3.webp', title: 'Cloud Security Audit', desc: 'Cloud infrastructure auditing session.' },
